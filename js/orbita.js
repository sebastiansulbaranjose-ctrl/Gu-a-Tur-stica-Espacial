    ...
    const SAT_NODE_ICON="img/Communications_satellite_with_TEMPO_spacecraft_model.png",ISS_NODE_ICON="img/ISS_spacecraft_model_1.png";
    const SAT_TYPE_ICONS={a:"img/Hubble_Space_Telescope_spacecraft_model.png",b:SAT_NODE_ICON,c:"img/Landsat_9_spacecraft_model_1.png"};
    ...
    (()=>{
      ...
      const cosmicScales=[
        ...
        {name:"Plutón",classification:"Planeta Enano (Cinturón de Kuiper)",tier:"planetario",diameterKm:2377,diameterLabel:"≈ 2.377 km de diámetro",fact:"Es más pequeño que la Luna terrestre, pero tiene cinco lunas propias, incluida Caronte.",image:"img/Pluto_in_True_Color_-_High-Res.jpg"},
