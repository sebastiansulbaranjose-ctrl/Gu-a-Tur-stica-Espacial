(() => {
  ...
  const SUBTOPIC_MEDIA = {
    ...
    "nucleosintesis-primordial": { image: "img/Orion_Nebula_-_Hubble_2006_mosaic_edit.jpg", caption: "Nubes de hidrógeno y helio, los primeros elementos que existieron", keys: ["hidrógeno y helio","la temperatura y la densidad cayeron demasiado rápido","en el interior de las estrellas"], journal: "Minutos después del origen ya había materia: hidrógeno y helio, nada más pesado. El universo se enfrió demasiado rápido para cocinar otra cosa. Todo lo demás —el hierro de mi casco, el calcio de mis huesos— tuvo que esperar a las estrellas." },
    ...
    "agujeros-negros-supermasivos": { image: "img/Black_hole_-_Messier_87.jpg", caption: "Primera imagen real de un agujero negro supermasivo (M87*)", keys: ["En el centro de la mayoría de las galaxias","millones o incluso miles de millones de veces la del Sol","influye en la estructura y evolución de toda la galaxia"], journal: "En el corazón de casi toda galaxia hay un agujero negro supermasivo. No es un monstruo devorador: es un ancla que ordena la estructura entera de la galaxia a su alrededor. Mi dispositivo se estabiliza cerca de ellos. Curioso: lo que más deforma el tiempo es también lo que me da una referencia." },
    ...
    "atmosfera-oceanos": { image: "img/Top_of_Atmosphere.jpg", caption: "Las capas de la atmósfera terrestre vistas desde la órbita", keys: ["desgasificación","Vapor de agua, dióxido de carbono y nitrógeno","cometas helados"], journal: "La primera atmósfera de la Tierra no tenía oxígeno: era vapor, CO₂ y nitrógeno expulsados por volcanes, más el agua que trajeron cometas y asteroides. Cuando el planeta se enfrió, ese vapor llovió durante siglos y llenó los océanos. Respiro por costumbre; aquí no podría hacerlo." },
  ...
  const INTRO_IMG = "img/International_Space_Station.jpg";
